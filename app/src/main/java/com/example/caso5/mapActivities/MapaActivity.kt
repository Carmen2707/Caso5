...
import com.example.caso5.databinding.ActivityMapaBinding
...
class MapaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        items.add(
            OverlayItem(
                "Canarias - Capital: Las Palmas de GC y SC de Tenerife",
                "Habitantes:2172944",
        ...
        items.add(
            OverlayItem(
                "Castilla y León - Capital: No tiene (Valladolid)",
                "Habitantes:2383139",
        ...
        items.add(
            OverlayItem(
                "Castilla La Mancha - Capital: No tiene (Toledo)",
                "Habitantes:2049562",
